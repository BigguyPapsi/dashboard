...
<td>
  ...
  <td class="text-center">
    <viewer :images="item.img">
      <img style="width: 50px; height: 50px; object-fit: cover;" :src="'http://localhost:8000/storage/'+  item.img">
    </viewer>
  </td>
  <td>{{ item.name }}</td>
...
<router-link to="/user/create"><b-button variant="primary">
...
export default{
  ...
  mounted() {
    ...
    axios .get("http://localhost:8000/api/product_type", {
        headers: {
